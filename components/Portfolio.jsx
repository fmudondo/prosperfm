...
const Portfolio = () => {
  ...
  return (
    <div
      id="portfolio"
      className="w-full bg-gradient-to-r from-orange-600 to-gray-400"
    >
      <div className="max-w-screen-xl mx-auto px-8 py-16 text-center md:text-left">
        <h2 className="text-5xl md:text-6xl tracking-wider uppercase text-black font-bold">
          Portfolio
        </h2>
        <p className="py-4 max-w-lg">Below is a summary of some of my work.</p>
          ...
          {portfolios.map(({ id, title, imageSrc, url }) => (
            <Link key={id} href={`/portfolio/${url}`}>
              <div className="cursor-pointer group shadow-md shadow-gray-600 overflow-hidden rounded-md">
                ...
                />
                <h2
                  className="text-center text-base capitalize my-4 font-light duration-200 
