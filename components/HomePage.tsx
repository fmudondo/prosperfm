  ...
  return (
    ...
    <div id='home' className="h-screen w-full text-center">
      ...
      <BsFillMoonStarsFill onClick={() => setDarkMode(!darkMode)}  className='cursor-pointer text-2xl'/>
        ...
        <h1 className='uppercase font-bold text-black text-6xl'>full stack developer</h1>
        <p className='text-black max-w-sm mx-auto text-center text-lg'>
          My name is Prosper Farai Mudondo, an undergraduate student at Harare Institute of Technology (HIT) 
          persuing Honors Technology Degree in Electronic Commerce.
        </p>
